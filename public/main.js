...
},{"gsap":327,"scrollmagic":329}],331:[function(require,module,exports){
/**
...
var _indexOfChild = require('../utilities/helpers/indexOfChild');

var _indexOfChild2 = _interopRequireDefault(_indexOfChild);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

function coverSlider(slider) {
    ...
    var slides = slider.querySelectorAll('.cover-slider_slide');
    var indicators = slider.querySelectorAll('.cover-slider_indicator');
    var hammer = new _hammerjs2.default(slider);

    var activeSlide = void 0;
    var activeSlideImage = void 0;
    var activeIndicator = void 0;
    var newSlide = void 0;
    var newSlideImage = void 0;
    var newIndicator = void 0;
    var newSlideElements = void 0;

    nextSlide(slider, auto, 0);

    [].concat(_toConsumableArray(indicators)).forEach(function (indicator) {
        indicator.style.opacity = 1;
        indicator.addEventListener('click', function () {
            nextSlide(slider, auto, (0, _indexOfChild2.default)(indicator));
        });
    });
    ...
    function nextSlide(slider) {
        ...
        var previous = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;

        activeSlide = [].concat(_toConsumableArray(slides)).filter(function (x) {
        ...
        if (previous) {
            ...
            if (!newSlide) {
                newSlide = [].concat(_toConsumableArray(slides))[slides.length - 1];
            }
        } else if (index === null) {
            newSlide = activeSlide.nextElementSibling;
            if (!newSlide) {
                newSlide = [].concat(_toConsumableArray(slides))[0];
            }
        } else {
            newSlide = [].concat(_toConsumableArray(slides))[index];
        }
    ...
    function switchSlides(slider, newSlide, auto, previous) {
        if (slider.dataset.wait) {
            return;
        }
        if (activeSlide) {
            activeSlideImage = activeSlide.querySelector('.cover-slider_bg-container');
            activeIndicator = [].concat(_toConsumableArray(indicators))[(0, _indexOfChild2.default)(activeSlide)].querySelector('span');
        }
        newIndicator = [].concat(_toConsumableArray(indicators))[(0, _indexOfChild2.default)(newSlide)].querySelector('span');
        ...
        if (Object.is(newSlide, activeSlide)) {
            return;
        }
        ...
        if (activeSlide) {
            _gsap.TweenMax.killTweensOf(activeIndicator);
            _gsap.TweenMax.set(activeIndicator, { clearProps: 'all' });
            _gsap.TweenMax.fromTo(activeSlideImage, animationTime, {
        ...
        _gsap.TweenMax.fromTo(newIndicator, animationTime, {
            width: 0,
            right: 'auto',
            left: 0
        }, {
        ...
        if (auto) {
            _gsap.TweenMax.to(newIndicator, timePerSlide / 1000 - animationTime, {
                width: '0',
                right: 0,
                left: 'auto',
            ...
            _gsap.TweenMax.to(newSlideImage, timePerSlide / 1000 + 1, {
                scale: 1.05,
                ease: _gsap.Linear.easeNone,
                clearProps: 'all'
            }, animationTime);
        }
        _gsap.TweenMax.fromTo(newSlide, animationTime, {
            display: 'block',
        ...
        _gsap.TweenMax.fromTo(newSlideImage, animationTime, {
        ...
        _gsap.TweenMax.staggerFromTo(newSlideElements, animationTime, {
            alpha: 0,
            x: 100
        }, {
            alpha: 1,
...
},{"../utilities/helpers/indexOfChild":346,"gsap":327,"hammerjs":328}],334:[function(require,module,exports){
'use strict';
...
function contact(container) {
    var markerPinWrap = document.querySelector('.c-marker_pin-wrap');
    var markerPin = document.querySelector('.c-marker_pin');
    var markerShadow = document.querySelector('.c-marker_shadow');

    var tl = new _gsap.TimelineMax({ paused: true }).to(markerPin, 0.1, {
        scaleY: 0.87,
        ease: _gsap.Power1.easeOut
    }).to(markerPin, 0.55, {
        scaleY: 1,
        ease: _gsap.Elastic.easeOut.config(1.2, 0.5)
    }).to(markerPin, 0.1, {
        scaleY: 0.87,
        ease: _gsap.Power1.easeOut
    }).to(markerPin, 0.8, {
        ...
        y: -30,
        ease: _gsap.SlowMo.ease.config(0.1, 0.1, true)
    }, 0.15).to(markerShadow, 0.5, {
        scale: 0.6,
        ease: _gsap.SlowMo.ease.config(0.1, 0.1, true)
    }, 0.15);
...
},{"gsap":327}],335:[function(require,module,exports){
'use strict';
...
function services(service) {
    var img = service.querySelector('.service_img');
    var title = service.querySelector('.service_title');
    var arrow = service.querySelector('.service_arrow');
    var tl = new _gsap.TimelineMax({ paused: true });
    var animationTime = 1.25;

    tl.to(img, animationTime, {
        scale: 1.1,
        ease: _gsap.Power4.easeInOut
    }).to(title, animationTime, {
        x: -50,
        ease: _gsap.Power4.easeInOut
    }, 0).to(arrow, animationTime, {
        width: '4rem',
        ease: _gsap.Power4.easeInOut
    }, 0);
...
},{"gsap":327}],336:[function(require,module,exports){
'use strict';
...
function loading(loadingScreen) {
    var loader = loadingScreen.querySelector('.c-loading_logo path');
    var segment = new Segment(loader);

    new _gsap.TimelineMax({ repeat: -1 }).set(loader, {
...
},{"gsap":327,"segment-js":331}],337:[function(require,module,exports){
'use strict';
...
var _screenSize = require('../utilities/helpers/screenSize');
...
/* global google */
function initMap() {
    var position = new google.maps.LatLng(48.31533, 18.0877);
    var mapContainer = document.getElementById('map');

    var panorama = new google.maps.StreetViewPanorama(mapContainer, {
    ...
    marker.setValues({ position: position, map: map });
...
},{"../utilities/helpers/screenSize":347}],338:[function(require,module,exports){
'use strict';
...
function search(menu) {
    var animationTime = 1;
    var menuList = menu.querySelector('.c-menu_list');
    var menuItems = menuList.querySelectorAll('.c-menu_item');
    var tl = new _gsap.TimelineMax({ paused: true, reversed: true });

    _gsap.TweenMax.fromTo(menu, animationTime, {
        alpha: 0
    }, {
        alpha: 1,
        ease: _gsap.Expo.easeInOut,
    ...
    tl.fromTo(menuList, animationTime, {
        left: '100%'
    }, {
        left: '0%',
        ease: _gsap.Expo.easeInOut
    ...
    menu.querySelector('.c-menu_icon').addEventListener('click', function () {
        menu.classList.toggle('is-open');
        toggleTl();
    });

    window.addEventListener('resize', function () {
        if (_screenSize2.default.changed() && _screenSize2.default.lg()) {
            _gsap.TweenMax.fromTo(menuItems, animationTime, {
                alpha: 0,
                x: 0
            }, {
                alpha: 1,
...
},{"../utilities/helpers/screenSize":347,"gsap":327}],339:[function(require,module,exports){
'use strict';
...
function reviewsSlider(slider) {
    ...
    var slides = slider.querySelectorAll('.c-reviews-slider_slide');
    var indicators = slider.querySelectorAll('.c-reviews-slider_indicator');
    var hammer = new _hammerjs2.default(slider);
    ...
    function switchSlides(slider, newSlide, auto, previous) {
        ...
        if (activeSlide) {
            [].concat(_toConsumableArray(indicators))[(0, _indexOfChild2.default)(activeSlide)].classList.remove('is-active');
            previous = (0, _indexOfChild2.default)(newSlide) < (0, _indexOfChild2.default)(activeSlide);
        } else {
            activeSlide = [].concat(_toConsumableArray(slides))[0];
        }

        [].concat(_toConsumableArray(indicators))[(0, _indexOfChild2.default)(newSlide)].classList.add('is-active');

        clearTimeout(timeout);
        slider.dataset.wait = 'true';

        var cornerLeft = newSlide.querySelector('.c-reviews-slider_corner__left');
        var cornerRight = newSlide.querySelector('.c-reviews-slider_corner__right');

        new _gsap.TimelineMax().to(activeSlide, animationTime, {
            x: previous ? '10%' : '-10%',
            opacity: 0,
            ease: _gsap.Expo.easeInOut
            ...
            opacity: 1,
            ease: _gsap.Expo.easeOut
        }, '=-' + animationTime / 2).fromTo(cornerRight, animationTime, {
            right: '4rem',
            bottom: '4rem',
            opacity: 0
        }, {
            ...
            opacity: 1,
            ease: _gsap.Expo.easeOut
        }, '=-' + animationTime).fromTo(newSlide, animationTime, {
            display: 'block',
            opacity: 0,
            x: previous ? '-10%' : '10%',
            zIndex: 2
            ...
            onComplete: function onComplete() {
                activeSlide.classList.remove('is-active');
                _gsap.TweenMax.set(activeSlide, { clearProps: 'all' });
                newSlide.classList.add('is-active');
                delete slider.dataset.wait;
            }
        }, 0);
...
},{"../utilities/helpers/indexOfChild":346,"gsap":327,"hammerjs":328}],340:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.benefitsTitle = benefitsTitle;
exports.benefit = benefit;

var _gsap = require('gsap');

function benefitsTitle(animationTime) {
    var benefitsHeading = document.querySelector('.benefits_heading');

    return new _gsap.TimelineMax().from(benefitsHeading, animationTime, {
        y: '100',
        ease: _gsap.Expo.easeOut
...
function benefit(benefit, animationTime) {
    return new _gsap.TimelineMax().from(benefit, animationTime / 2, {
        alpha: 0,
        ease: _gsap.Linear.easeNone
...
},{"gsap":327}],341:[function(require,module,exports){
'use strict';
...
function contact(animationTime) {
    var contact = document.querySelector('.contact');
    var contactOverlay = contact.querySelector('.contact_overlay');
    var contactElements = contact.querySelectorAll('.contact_block');
    var mapContainer = contact.querySelector('.contact_map');
    var markerPinWrap = contact.querySelector('.c-marker_pin-wrap');
    var markerPin = contact.querySelector('.c-marker_pin');
    var markerShadow = contact.querySelector('.c-marker_shadow');

    return new _gsap.TimelineMax().from(contactOverlay, animationTime, {
        x: '-100%',
        ease: _gsap.Expo.easeInOut
    }).staggerFrom(contactElements, animationTime, {
        x: 100,
        ease: _gsap.Expo.easeOut
    }, 0.15, 0.75).staggerFrom(contactElements, animationTime, {
        alpha: 0,
        ease: _gsap.Linear.easeNone
    }, 0.15, 0.75).from(markerPinWrap, 1.8, {
        y: '-' + mapContainer.offsetHeight + 'px',
        ease: _gsap.Bounce.easeOut
    }, 0).from(markerShadow, 1.8, {
        scale: 0,
        ease: _gsap.Bounce.easeOut
    }, 0);
}

},{"gsap":327}],342:[function(require,module,exports){
'use strict';
...
function scroll(container) {
    ...
    var services = [].concat(_toConsumableArray(container.querySelectorAll('.service')));
    var benefits = [].concat(_toConsumableArray(container.querySelectorAll('.benefits_item')));
    var animationTime = 1;
    ...
    new _scrollmagic2.default.Scene({
        ...
        triggerHook: 0.7,
        reverse: false
    }).setTween((0, _contact2.default)(animationTime)).addTo(controller);

    new _scrollmagic2.default.Scene({
        triggerElement: '.benefits',
        triggerHook: 0.8,
        reverse: false
    }).setTween((0, _benefits.benefitsTitle)(animationTime)).addTo(controller);

    benefits.forEach(function (benefitEl) {
        new _scrollmagic2.default.Scene({
            triggerElement: benefitEl,
            triggerHook: 0.7,
            reverse: false
        }).setTween((0, _benefits.benefit)(benefitEl, animationTime)).addTo(controller);
    });
    ...
    services.forEach(function (serviceEl) {
        new _scrollmagic2.default.Scene({
            ...
            triggerHook: 0.7,
            reverse: false
        }).setTween((0, _service2.default)(serviceEl, animationTime)).addTo(controller);
    });
    ...
    new _scrollmagic2.default.Scene({
        ...
        (0, _init2.default)(_reviewsSlider2.default, document.querySelector('.js-reviews-slider'), _screenSize2.default.lg());
    }).addTo(controller);
}

},{"../../utilities/helpers/screenSize":347,"../../utilities/init":348,"../reviewsSlider":339,"./benefits":340,"./contact":341,"./service":343,"scrollmagic":329,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":330}],343:[function(require,module,exports){
'use strict';
...
function service(service, animationTime) {
    var imageWrap = service.querySelector('.service_img-wrapper');
    var text = service.querySelectorAll('.service_text > *');

    return new _gsap.TimelineMax().from(imageWrap, animationTime, {
        x: '-100',
        ease: _gsap.Expo.easeOut
    }).from(imageWrap, animationTime, {
        alpha: 0,
        ease: _gsap.Linear.easeNone
    }, 0).staggerFrom(text, animationTime, {
        alpha: 0,
        ease: _gsap.Linear.easeNone
    }, 0.15, 0).staggerFrom(text, animationTime, {
        x: 100,
        ease: _gsap.Expo.easeOut
    }, 0.15, 0);
}

},{"gsap":327}],344:[function(require,module,exports){
'use strict';
...
function search(container) {
    container.querySelector('.c-search_close').addEventListener('click', function () {
        return container.classList.toggle('is-open');
    });
}
...
var _search = require('./animation/search');

var _search2 = _interopRequireDefault(_search);

var _menu = require('./animation/menu');

var _menu2 = _interopRequireDefault(_menu);

var _cover_slider = require('./animation/cover_slider');

var _cover_slider2 = _interopRequireDefault(_cover_slider);

var _contact = require('./animation/hover/contact');

var _contact2 = _interopRequireDefault(_contact);

var _loading = require('./animation/loading');

var _loading2 = _interopRequireDefault(_loading);

var _scroll = require('./animation/scroll/scroll');

var _scroll2 = _interopRequireDefault(_scroll);

var _services = require('./animation/hover/services');

var _services2 = _interopRequireDefault(_services);

var _map = require('./animation/map');
...
var _reviewsSlider = require('./animation/reviewsSlider');
...
var app = function app(config) {
    ...
    (0, _init2.default)(_loading2.default, document.querySelector('.js-loading'));
    window.addEventListener('load', function () {
        (0, _init2.default)(_scroll2.default, document);
        (0, _init2.default)(_cover_slider2.default, document.querySelector('.js-cover_slider'), _screenSize2.default.lg());
        (0, _init2.default)(_menu2.default, document.querySelector('.js-nav'));
        (0, _init2.default)(_search2.default, document.querySelector('.js-search'));
        if (_screenSize2.default.lg()) {
            (0, _init2.default)(_contact2.default, document.querySelector('.js-contact'));
            (0, _init2.default)(_services2.default, document.querySelectorAll('.js-service'));
        }
    });
};
...
},{"./animation/cover_slider":333,"./animation/hover/contact":334,"./animation/hover/services":335,"./animation/loading":336,"./animation/map":337,"./animation/menu":338,"./animation/reviewsSlider":339,"./animation/scroll/scroll":342,"./animation/search":344,"./utilities/helpers/screenSize":347,"./utilities/init":348,"babel-polyfill":1,"svgxuse":332}],346:[function(require,module,exports){
"use strict";
...
exports.default = screenSize = {
    // medium
    md: function md() {
        return window.matchMedia('(min-width: ' + mediumWidth + 'px) and (max-width: ' + (largeWidth - 1) + 'px)').matches;
    },
    // not small (medium and large)
    ns: function ns() {
        return window.matchMedia('(min-width: ' + mediumWidth + 'px)').matches;
    },
    // not large (small and medium)
    nlg: function nlg() {
        return window.matchMedia('(max-width: ' + (largeWidth - 1) + 'px)').matches;
    },
    // large
    lg: function lg() {
        return window.matchMedia('(min-width: ' + largeWidth + 'px)').matches;
    },
    changed: function changed() {
        var newScreen = void 0;
        if (screenSize.md()) {
            newScreen = 'medium';
    ...
    if (containers) {
        try {
            if (NodeList.prototype.isPrototypeOf(containers)) {
                return [].concat(_toConsumableArray(containers)).map(function (container) {
                    return fn.apply(undefined, [container].concat(args));
                });
            } else {
                return fn.apply(undefined, [containers].concat(args));
            }
        } catch (e) {
            /* eslint-disable */
            console.error(e);
